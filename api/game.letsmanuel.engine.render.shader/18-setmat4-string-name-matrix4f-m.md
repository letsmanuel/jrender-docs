...
**Visibility:** `public`  
**Signature:** `public void setMat4(String name, Matrix4f m)`
...
| `m` | `Matrix4f` | Caller-supplied input; verify range, units, lifecycle, and nullability. |

### Argument details

- `String name`: validate type, range, coordinate space, ownership, and nullability before calling.
- `Matrix4f m`: validate type, range, coordinate space, ownership, and nullability before calling.
