...
**Visibility:** `public`  
**Signature:** `public Transform setRotationDeg(float x, float y, float z)`

## What it does

This function belongs to `game.letsmanuel.engine.core.Transform` and performs the operation represented by `setRotationDeg`. Use it according to the lifecycle and ownership rules of the declaring type.
...
Transform result = instance.setRotationDeg(x, y, z);
```
