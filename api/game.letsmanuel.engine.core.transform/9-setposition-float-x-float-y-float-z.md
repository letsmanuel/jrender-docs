...
**Visibility:** `public`  
**Signature:** `public Transform setPosition(float x, float y, float z)`

## What it does

This function belongs to `game.letsmanuel.engine.core.Transform` and performs the operation represented by `setPosition`. Use it according to the lifecycle and ownership rules of the declaring type.
...
Transform result = instance.setPosition(x, y, z);
```
