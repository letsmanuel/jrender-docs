...
**Visibility:** `public`  
**Signature:** `public GuiBlur setTint(float r, float g, float b)`

## What it does

This function belongs to `game.letsmanuel.engine.gui.GuiBlur` and performs the operation represented by `setTint`. Use it according to the lifecycle and ownership rules of the declaring type.
...
GuiBlur result = instance.setTint(r, g, b);
```
