...
**Visibility:** `public`  
**Signature:** `public void remove(GuiElement e)`

## What it does

This function belongs to `game.letsmanuel.engine.gui.Gui` and performs the operation represented by `remove`. Use it according to the lifecycle and ownership rules of the declaring type.
