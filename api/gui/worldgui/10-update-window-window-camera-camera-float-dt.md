...
**Visibility:** `public`  
**Signature:** `public void update(Window window, Camera camera, float dt)`

## What it does

This function belongs to `game.letsmanuel.engine.gui.WorldGui` and performs the operation represented by `update`. Use it according to the lifecycle and ownership rules of the declaring type.
...
instance.update(window, camera, dt);
```
