...
**Source path:** `engine/src/main/java/game/letsmanuel/engine/gui/GuiTooltipStyle.java`

## Purpose

GuiTooltipStyle is part of the Letsmanuel engine API. Each function page documents its signature, arguments, return behavior, sample usage, common issues, reusable template, and agent instructions.
