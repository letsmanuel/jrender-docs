...
This function belongs to `game.letsmanuel.engine.gui.GuiText` and performs the operation represented by `r`. Use it according to the lifecycle and ownership rules of the declaring type.
