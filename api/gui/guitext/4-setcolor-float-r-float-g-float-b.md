...
**Visibility:** `public`  
**Signature:** `public GuiText setColor(float r, float g, float b)`

## What it does

This function belongs to `game.letsmanuel.engine.gui.GuiText` and performs the operation represented by `setColor`. Use it according to the lifecycle and ownership rules of the declaring type.
...
GuiText result = instance.setColor(r, g, b);
```
