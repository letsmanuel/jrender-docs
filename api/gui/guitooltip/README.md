...
**Source path:** `engine/src/main/java/game/letsmanuel/engine/gui/GuiTooltip.java`

## Purpose

GuiTooltip is part of the Letsmanuel engine API. Each function page documents its signature, arguments, return behavior, sample usage, common issues, reusable template, and agent instructions.
