...
**Visibility:** `public`  
**Signature:** `public GuiSlide r(float x, float y, float w, float h)`

## What it does

This function belongs to `game.letsmanuel.engine.gui.GuiSlider` and performs the operation represented by `r`. Use it according to the lifecycle and ownership rules of the declaring type.
...
Returns a value of type `GuiSlide`.

## Code sample

```java
// Obtain or construct the owning instance before this call.
GuiSlide result = instance.r(x, y, w, h);
```
