...
**Source path:** `engine/src/main/java/game/letsmanuel/engine/gui/HoverAnim.java`

## Purpose

HoverAnim is part of the Letsmanuel engine API. Each function page documents its signature, arguments, return behavior, sample usage, common issues, reusable template, and agent instructions.
