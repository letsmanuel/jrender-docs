...
This function belongs to `game.letsmanuel.engine.scene.Scene` and performs the operation represented by `name`. Use it according to the lifecycle and ownership rules of the declaring type.
