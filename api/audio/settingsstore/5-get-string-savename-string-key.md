...
**Visibility:** `public`  
**Signature:** `public Object get(String saveName, String key)`

## What it does

This function belongs to `game.letsmanuel.engine.SettingsStore` and performs the operation represented by `get`. Use it according to the lifecycle and ownership rules of the declaring type.
...
Object result = instance.get(saveName, key);
```
...
When modifying code that calls `get`, preserve argument order and types, search existing call sites first, keep lifecycle ownership explicit, and update this page if behavior changes.
