...
This function belongs to `game.letsmanuel.engine.render.Shader` and performs the operation represented by `dispose`. Use it according to the lifecycle and ownership rules of the declaring type.
