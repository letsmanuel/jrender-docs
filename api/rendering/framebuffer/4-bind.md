...
**Visibility:** `public`  
**Signature:** `public void bind()`

## What it does

This function belongs to `game.letsmanuel.engine.render.Framebuffer` and performs the operation represented by `bind`. Use it according to the lifecycle and ownership rules of the declaring type.
