...
**Visibility:** `public`  
**Signature:** `public Scene create(String name)`

## What it does

This function belongs to `game.letsmanuel.engine.scene.SceneManager` and performs the operation represented by `create`. Use it according to the lifecycle and ownership rules of the declaring type.
...
Scene result = instance.create(name);
```
