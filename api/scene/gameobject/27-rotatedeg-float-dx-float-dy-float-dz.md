...
**Visibility:** `public`  
**Signature:** `public GameObject rotateDeg(float dx, float dy, float dz)`

## What it does

This function belongs to `game.letsmanuel.engine.object.GameObject` and performs the operation represented by `rotateDeg`. Use it according to the lifecycle and ownership rules of the declaring type.
...
GameObject result = instance.rotateDeg(dx, dy, dz);
```
