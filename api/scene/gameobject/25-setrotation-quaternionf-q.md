...
**Visibility:** `public`  
**Signature:** `public GameObject setRotation(Quaternionf q)`

## What it does

This function belongs to `game.letsmanuel.engine.object.GameObject` and performs the operation represented by `setRotation`. Use it according to the lifecycle and ownership rules of the declaring type.
...
GameObject result = instance.setRotation(q);
```
