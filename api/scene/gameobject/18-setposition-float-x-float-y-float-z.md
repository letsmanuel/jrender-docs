...
**Visibility:** `public`  
**Signature:** `public GameObject setPosition(float x, float y, float z)`

## What it does

This function belongs to `game.letsmanuel.engine.object.GameObject` and performs the operation represented by `setPosition`. Use it according to the lifecycle and ownership rules of the declaring type.
...
GameObject result = instance.setPosition(x, y, z);
```
