...
This function belongs to `game.letsmanuel.engine.object.GameObject` and performs the operation represented by `position`. Use it according to the lifecycle and ownership rules of the declaring type.
